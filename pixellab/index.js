...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ============================================
    // FILTRO DE PESQUISA NOS DEPOIMENTOS
    ...
    searchInput.addEventListener("input", () => {
        ...
        cards.forEach(card => {
            ...
            const handle = card.querySelector(".user-handle").textContent.toLowerCase();
            const text = card.querySelector(".testimonial-text").textContent.toLowerCase();

            if (name.includes(searchText) || handle.includes(searchText) || text.includes(searchText)) {
